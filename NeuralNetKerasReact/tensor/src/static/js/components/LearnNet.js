...
export default class LearnNet extends React.Component {
	...
	handleCloseOK = () => {
		console.log('_NetLearn RIGHT NOW');
		this.props._NetLearn();
	...
	render() {
		...
		return (						
			<div>
				...
				<Button variant="outlined" color="primary" style={{margin: "1%", width:"90%"}} onClick={this.handleCloseOK}>
					Обучить НС на готовых наборах данных
				</Button>
